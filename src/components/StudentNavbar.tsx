    ...
    <>
      ...
      <div className={`hidden lg:flex flex-col fixed left-0 top-0 h-full bg-white border-r border-gray-200 shadow-xl transition-all duration-300 z-40 ${
        ...
        <div className="p-4 border-t border-gray-200 space-y-2">
          ...
          <Link 
            to="/student/profile" 
            className={`flex items-center space-x-3 px-4 py-3 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-xl transition-all duration-300 ${collapsed ? 'px-2' : 'px-4'}`}
          >
